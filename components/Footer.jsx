  ...
  className={`${styles.paddings} py-8 relative`}>
    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      <div className="flex items-center justify-between flex-wrap gap-5">
        {/* create a small text box to allow users to enter their message it should have a glowing green border,  */}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary-yellow" viewBox="0 0 20 20" fill="currentColor">
