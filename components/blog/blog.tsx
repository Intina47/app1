...
const ContentCard = ({ img, title, desc }: ContentCardPropsType) => (
  <Card placeholder={undefined}>
    ...
    <CardBody placeholder={undefined}>
      <Typography variant="h4" placeholder={undefined}>{title}</Typography>
      <Typography variant="paragraph" placeholder={undefined}>{desc}</Typography>
    </CardBody>
  </Card>
);
...
export const BlogPage = () => (
  <section>
    <Typography variant="h2" placeholder={undefined}>Good girl with bad habits</Typography>
    <Typography variant="lead" placeholder={undefined}>
      Meet our favorite paradox: a good girl with a few mischievous quirks.
      She's the heart of the party, spreading joy with every laugh and dance move.
      Let us hear what she has to say about how to have a splendid night out.
      Remember to join us for a night of carefree fun, where even the good ones let
      loose and make unforgettable memories.
    </Typography>
